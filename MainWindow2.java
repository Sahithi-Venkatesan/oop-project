...
public class MainWindow2 extends JFrame {
	...
	public MainWindow2() {
		...
		homepage_bg.setBounds(-4, 0, 1849, 942);
		...
		JLabel lblNewLabel_11 = new JLabel("Become a proud volunteer");
		lblNewLabel_11.setForeground(Color.WHITE);
		lblNewLabel_11.setFont(new Font("Segoe UI Emoji", Font.BOLD, 37));
		lblNewLabel_11.setBounds(141, 104, 512, 84);
		vol.add(lblNewLabel_11);
		...
		lblNewLabel_12.setFont(new Font("Segoe UI Emoji", Font.BOLD, 21));
		lblNewLabel_12.setForeground(Color.WHITE);
		lblNewLabel_12.setBounds(619, 393, 63, 23);
		vol.add(lblNewLabel_12);
			...
			public void actionPerformed(ActionEvent event)
			{
				...
				if(tf_username.getText().equals("Drishtiadmin@2020") && tf_password.getText().equals("dri_439"))
				{
					JOptionPane.showMessageDialog((Component)event.getSource(),"Successfully signed in!","Log in", JOptionPane.INFORMATION_MESSAGE);
					 ...
					 Adminlogin adlog=new Adminlogin(nameid,mobileid,mailid,concernid,vnametf.getText(),vmobtf.getText(),vmailtf.getText(),vloctf.getText(),vagetf.getText(),vproftf.getText());
		...
		JLabel lblNewLabel_13 = new JLabel(" programmes and assisting many vulnerable people in need.");
		lblNewLabel_13.setFont(new Font("Segoe UI Emoji", Font.BOLD, 20));
		lblNewLabel_13.setForeground(Color.WHITE);
		lblNewLabel_13.setBounds(1143, 352, 700, 51);
		vol.add(lblNewLabel_13);
		
		JLabel lblNewLabel_14 = new JLabel("Drishti recruits volunteers irrespective of their race, ethnicity, sex,");
		lblNewLabel_14.setFont(new Font("Segoe UI Historic", Font.BOLD, 20));
		lblNewLabel_14.setForeground(Color.WHITE);
		lblNewLabel_14.setBounds(1143, 416, 700, 32);
		vol.add(lblNewLabel_14);
		...
		lblNewLabel_19.setBounds(0, 0, 1920, 1080);
